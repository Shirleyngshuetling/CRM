...
<head>
    ...
    <link rel="stylesheet" href="css/customer_lead_list.css"> <!-- Updated CSS file -->
    <link rel="stylesheet" href="css/customer_lead_details.css">
        ...
        <div class="toast-box">
            <div class="toast-left">
                ...
                <div id="close_signup_toast" style="font-family: 'Poppins', sans-serif; font-weight:700;">
                    <?php check_customer_update_success(); ?>
                </div>
            </div>
    ...
    <section class="container">
        ...
        <div class="navigation">
            <ul class="nav-menu">
                ...
                <li><a href="customer_list.php" class="active-link"><span class="icon"><i class="fa-solid fa-users"></i></span><span class="title">Customers</span></a></li>
        ...
        <div class="main">
            ...
            <div class="middle-part">
                <h2 class="main-title"><b>Customers Management</b></h2>
                <div class="button-group">
                    <a href="add_customer.php" class="button submitBtn">Add Customer</a>
                </div>
            </div>

            <!-- Customer List Table -->
            <div class="customer-table">
                <h2 id="tableTitle">Customer List</h2>
                ...
                <div class="customerOptions">
                    ...
                    <div>
                        <div class="displayOptions displayOptionsBtn">
                            Display Options <img src="./assets/arrow-down-s-line.png" alt="">
                        </div>
                        <div class="showOptionsBox">
                            <div class="showOptions">
                                ...
                                <label class="showOption"><input type="checkbox" id="toggleNotes" checked> Notes</label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-scroll-container">
                    <table>
                        <thead>
                            <tr>
                                <th class="sortable" data-sort="customer_lead_id">ID <i class="fa fa-sort" id="icon-customer_lead_id"></i></th>
                                <th class="sortable" data-sort="name">Name <i class="fa fa-sort" id="icon-name"></i></th>
                                <th class="sortable" data-sort="company">Company <i class="fa fa-sort" id="icon-company"></i></th>
        ...
        <div class="details-container">
            <div class="details-header">
                ...
                <div class="details-actions">
                    <button id="edit-customer" title="Edit Customer"><i class="fa-solid fa-pen-to-square"></i></button>
            ...
            <div class="details-body">
                ...
                <!-- Tabs for Interactions/Reminders -->
